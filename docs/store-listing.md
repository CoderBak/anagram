...
| Screenshots | 1280×800 or 640×400, at least one, up to five. `docs/screenshots/` holds six at 1180×780 and 300×470 — none is a permitted size, so they have to be re-captured or padded. |
...
| Listing screenshots at 1280×800 or 640×400 | `docs/screenshots/` are 1180×780 / 300×470 — re-capture or pad |
