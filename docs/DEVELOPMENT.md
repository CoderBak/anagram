...
- Installer recovery: retryable interrupted uninstall, and serializing two component
  homes that race the same browser registration (`installer/native_registration.py`).
