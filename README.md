...
- **PDFs, reflowed and analyzed.** The browser's PDF viewer shows an image, not
  ...
  the text layer, the paragraphs are rebuilt in reading order (columns, running
  heads dropped, broken words mended), and the ordinary pipeline runs on the
